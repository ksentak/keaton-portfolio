...
exports.handler = async (event, context, callback) => {
  ...
  <body>
    <span class="preheader">You have received a message from keatonsentak.com.</span>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="mailto:${email}">Reply here</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">keatonsentak.com</span>
                  </td>
                </tr>
              </table>
            </div>
